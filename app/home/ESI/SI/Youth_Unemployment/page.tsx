...
const YouthUnemploymentStandardization: React.FC = () => {
  ...
  // New states for raw youth unemployment percentage and standardized score (for display and charts)
  const [actualYouthUnemployment, setActualYouthUnemployment] = useState<string | null>(null);
  ...
  const calculateStandardizedUnemployment = () => {
    ...
    setActualYouthUnemployment(unemploymentRate.toFixed(2));
  ...
  const handleCalculateAndSave = async () => {
    ...
    try {
      ...
      const postData = {
        ...
        youth_unemployment_standardized: parseFloat(standardizedScore || '0'),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Youth Unemployment measures the percentage of unemployed youth in the labor force, assessing employment opportunities for young people.
                  This tool calculates the raw unemployment rate from the inputs you provide and converts it into a standardized 0–100 score using predefined benchmarks.
                </p>
                <p className="font-mono mb-2">Youth Unemployment (raw) = (Unemployed Youth / Youth Labor Force) * 100%</p>
                <p className="mb-2">
                  Standardized score maps the fourth root of the rate to 100..0 across benchmarks (MIN..MAX) so lower unemployment → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of unemployed youth (non-negative).</li>
                  <li>Enter the total youth labor force (must be greater than zero).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like ILO or national labor statistics.</li>
          ...
          {comment && actualYouthUnemployment && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Youth Unemployment</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualYouthUnemployment}%
                    </p>
                  </div>
