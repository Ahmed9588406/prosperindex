...
const SlumHouseholdsStandardization: React.FC = () => {
  ...
  // New states for raw slum households percentage and standardized score (for display and charts)
  const [actualSlumHouseholds, setActualSlumHouseholds] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    setActualSlumHouseholds(slumHouseholds.toFixed(2));
    ...
    const postData = {
      ...
      slums_households_standardized: parseFloat(standardizedValue.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Slum Households measures the percentage of the population living in slums, assessing housing conditions.
                ...
                <p className="font-mono mb-2">Slum Households (raw) = (Slum Population / City Population) * 100%</p>
                <p className="mb-2">
                  Standardized score maps the percentage to 100..0 across benchmarks (MIN..MAX) so lower slum percentage → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of people living in slums (non-negative).</li>
                  <li>Enter the total city population (must be greater than zero).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like UN-Habitat or national censuses.</li>
          ...
          {evaluation && actualSlumHouseholds && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Slum Households</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualSlumHouseholds}%
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg">Standardized Slum Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
