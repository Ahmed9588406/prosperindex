...
const OldAgeDependencyCalculator: React.FC = () => {
  ...
  // New states for raw dependency ratio and standardized score (for display and charts)
  const [actualDependency, setActualDependency] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    let standardized = 100 * (1 - (lnRatio - minLogValue) / (maxLogValue - minLogValue));
    if (standardized > 100) standardized = 100;
    else if (standardized < 0) standardized = 0;
    ...
    setActualDependency(dependencyRatio.toFixed(2));
    ...
    const postData = {
      ...
      old_age_dependency_ratio_standardized: parseFloat(standardized.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Old Age Dependency Ratio measures the proportion of elderly people (65+) relative to the working-age population (15-64), assessing demographic pressures.
                  This tool calculates the raw ratio from the inputs you provide and converts it into a standardized 0–100 score using predefined benchmarks.
                </p>
                <p className="font-mono mb-2">Old Age Dependency Ratio (raw) = (People 65+ / People 15-64) * 100%</p>
                <p className="mb-2">
                  Standardized score maps ratio to 100..0 across benchmarks (MIN..MAX) so lower dependency → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of people aged 65 and over (non-negative).</li>
                  <li>Enter the number of people aged 15 to 64 (must be greater than zero).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like census data.</li>
          ...
          {decision && actualDependency && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Old Age Dependency Ratio</h3>
                  ...
                  <div>
                    <h3 className="text-lg">Standardized Dependency Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
