...
const InformalEmploymentCalculator: React.FC = () => {
  ...
  // New states for raw informal employment percentage and standardized score (for display and charts)
  const [actualInformalEmployment, setActualInformalEmployment] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    setActualInformalEmployment(ratio.toFixed(2));
    ...
    const postData = {
      ...
      informal_employment_standardized: parseFloat(standardized.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Informal Employment measures the percentage of employed persons in informal jobs, assessing labor market quality.
                ...
                <p className="font-mono mb-2">Informal Employment (raw) = (Informal Employees / Total Employed) * 100%</p>
                <p className="mb-2">
                  Standardized score maps percentage to 100..0 across benchmarks (MIN..MAX) so lower informal employment → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of informal employees (non-negative).</li>
                  <li>Enter the total number of employed persons (must be greater than zero).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like labor surveys.</li>
          ...
          {decision && actualInformalEmployment && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Informal Employment</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualInformalEmployment}%
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg">Standardized Informal Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
