...
function MaternalMortalityCalculator() {
  ...
  // New states for raw mortality rate and standardized score (for display and charts)
  const [actualMortality, setActualMortality] = useState<string | null>(null);
  ...
  const calculateMaternalMortality = async () => {
    ...
    setActualMortality(mortality.toFixed(2));
    ...
    const postData = {
      ...
      maternal_mortality_standardized: parseFloat(standardized.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Maternal Mortality measures the number of maternal deaths per 100,000 live births, assessing maternal health risks.
                ...
                <p className="font-mono mb-2">Maternal Mortality (raw) = (Deaths / Live Births) * 100,000 per 100,000 live births</p>
                <p className="mb-2">
                ...
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of maternal deaths (non-negative).</li>
          ...
          {decision && actualMortality && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Maternal Mortality</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualMortality} per 100,000 live births
                    </p>
                  </div>
