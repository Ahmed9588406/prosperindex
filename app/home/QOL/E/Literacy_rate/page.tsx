...
function LiteracyRateCalculator() {
  ...
  // New states for raw literacy rate and standardized score (for display and charts)
  const [actualLiteracy, setActualLiteracy] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    setActualLiteracy(rate.toFixed(2));
    ...
    const postData = {
      ...
      country,
      literacy_rate: rate,
      literacy_rate_standardized: parseFloat(standardized.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Literacy Rate measures the percentage of the population aged 15 and over who can read and write.
                  This tool calculates the raw literacy rate from the inputs you provide and converts it into a standardized 0–100 score using predefined benchmarks.
                </p>
                <p className="font-mono mb-2">Literacy Rate (raw) = (Literate Population / Total Population) * 100%</p>
                <p className="mb-2">
                  Standardized score maps rate to 100..0 across benchmarks (MIN..MAX) so higher literacy → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of literate people aged 15 and over.</li>
                  <li>Enter the total population aged 15 and over (must be greater than zero).</li>
          ...
          {decision && actualLiteracy && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Literacy Rate</h3>
                  ...
                  <div>
                    <h3 className="text-lg">Standardized Literacy Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
