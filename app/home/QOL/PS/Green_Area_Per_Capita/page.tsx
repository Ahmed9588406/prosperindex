...
const GreenAreaPerCapitaStandardization: React.FC = () => {
  ...
  // New states for raw green area per capita and standardized score (for display and charts)
  const [actualGreen, setActualGreen] = useState<string | null>(null);
  ...
  const calculateGreenAreaPerCapita = async () => {
    ...
    setActualGreen(greenAreaPerCapita.toFixed(2));
    ...
    const postData = {
      ...
      green_area_per_capita_standardized: parseFloat(standardized.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Green Area Per Capita measures the amount of green space available per person in the city.
                  This tool calculates the raw green area per capita from the inputs you provide and converts it into a standardized 0–100 score using predefined benchmarks.
                </p>
                <p className="font-mono mb-2">Green Area Per Capita (raw) = (Total Green Area / Population) m²</p>
                <p className="mb-2">
                  Standardized score maps per capita area to 100..0 with benchmark X so higher green area → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the total green area in square meters.</li>
          ...
          {decision && actualGreen && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Green Area Per Capita</h3>
                  ...
                  <div>
                    <h3 className="text-lg">Standardized Green Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
