...
const DaysToStartBusiness: React.FC = () => {
  ...
  // New states for raw days and standardized score (for display and charts)
  const [actualDays, setActualDays] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    const postData = {
      ...
      days_to_start_a_business_standardized: parseFloat(standardized.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Days to Start a Business measures the time required to legally start a business in the city.
                  This tool calculates the raw days from the input you provide and converts it into a standardized 0–100 score using predefined benchmarks.
                </p>
                <p className="font-mono mb-2">Days to Start a Business (raw) = Number of days</p>
                <p className="mb-2">
                  Standardized score maps days to 100..0 across benchmarks (MIN..MAX) so fewer days → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the average number of days required to start a business (positive number).</li>
                  <li>This should be based on local regulations and processes.</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like government reports.</li>
          ...
          {decision && actualDays && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Days to Start a Business</h3>
                  ...
                  <div>
                    <h3 className="text-lg">Standardized Business Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
