...
const SubnationalDebtIndicator: React.FC = () => {
  ...
  // New states for raw debt ratio and standardized score (for display and charts)
  const [actualDebt, setActualDebt] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    setActualDebt(debtRatio.toFixed(2));
    ...
    const postData = {
      ...
      subnational_debt_standardized: parseFloat(standardized.toFixed(2)),
  ...
  // Prepare pie data (standardized value + remainder)
    const standardizedValueNum = standardizedScore ? parseFloat(standardizedScore) : 0;
    const pieData = [
      { name: 'Standardized', value: Number(standardizedValueNum.toFixed(2)) },
      { name: 'Remaining', value: Number((100 - standardizedValueNum).toFixed(2)) }
    ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Subnational Debt measures the ratio of total debt to total revenue for subnational governments.
                  This tool calculates the raw debt ratio from the inputs you provide and converts it into a standardized 0–100 score using predefined benchmarks.
                </p>
                <p className="font-mono mb-2">Debt Ratio (raw) = (Total Debt / Total Revenue) * 100%</p>
                <p className="mb-2">
                  Standardized score maps ratio to 100..0 with benchmark X so lower debt → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the total existing debt (positive number).</li>
                  <li>Enter the total current revenue (positive number).</li>
          ...
          {decision && actualDebt && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Debt Ratio</h3>
                  ...
                  <div>
                    <h3 className="text-lg">Standardized Debt Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
