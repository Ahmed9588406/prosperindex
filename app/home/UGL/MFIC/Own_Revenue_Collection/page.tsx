...
const OwnRevenueCollection: React.FC = () => {
  ...
  // New states for raw revenue percentage and standardized score (for display and charts)
  const [actualRevenue, setActualRevenue] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    setActualRevenue(percentage.toFixed(2));
    ...
    const postData = {
      ...
      own_revenue_collection_standardized: parseFloat(standardized.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Own Revenue Collection measures the percentage of local revenue generated from own sources (not transfers).
                ...
                <p className="font-mono mb-2">Own Revenue Percentage (raw) = (Own Revenue / Total Revenue) * 100%</p>
                <p className="mb-2">
                  Standardized score maps percentage to 100..0 across benchmarks (MIN..MAX) so higher own revenue → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the own source revenue (positive number).</li>
                  <li>Enter the total local revenue (must be greater than zero).</li>
          ...
          {decision && actualRevenue && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Own Revenue Percentage</h3>
                  ...
                  <div>
                    <h3 className="text-lg">Standardized Revenue Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="w-full h-64">
                      ...
                      <BarChart data={[
                        { name: 'Standardized', value: standardizedNumeric }
                      ]}>
