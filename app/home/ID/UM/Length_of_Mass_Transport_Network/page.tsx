...
function LengthMassTransportNetworkForm() {
  ...
  // New states for raw length per million and standardized score (for display and charts)
  const [actualLength, setActualLength] = useState<string | null>(null);
  const [standardizedScore, setStandardizedScore] = useState<number | null>(null); // numeric standardized score for calculations/display
  ...
  const calculateAndSave = async () => {
    ...
    setActualLength(lengthPerMillionValue.toFixed(2));
    // standardizedScore is numeric; format when rendering
    ...
    const postData = {
      ...
      length_of_mass_transport_network_standardized: parseFloat(standardizedScoreValue.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Length of Mass Transport Network measures the total length of mass transport lanes per 1,000,000 population, assessing public transport infrastructure.
                  This tool calculates the raw length from the inputs you provide and converts it into a standardized 0–100 score using predefined benchmarks.
                </p>
                <p className="font-mono mb-2">Length per 1,000,000 (raw) = (Total Length / Population) * 1,000,000 km</p>
                <p className="mb-2">
                  Standardized score maps length to 100..0 with benchmark X so higher length → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the total length of mass transport lanes (in km).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like transport authorities.</li>
          ...
          {decision && actualLength && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Transport Length</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualLength} km per 1,000,000
                    </p>
                  </div>
