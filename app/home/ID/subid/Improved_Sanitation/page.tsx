...
function ImprovedSanitationForm() {
  ...
  // New states for raw improved sanitation percentage and standardized score (for display and charts)
  const [actualImprovedSanitation, setActualImprovedSanitation] = useState<string | null>(null);
  ...
  const calculateImprovedSanitation = async () => {
    ...
    if (numericTotalHouseholds > 0) {
      ...
      setActualImprovedSanitation(improvedSanitation.toFixed(2));
      setStandardizedScore(standardizedImprovedSanitation.toFixed(2));
      ...
      const postData = {
        ...
        improved_sanitation_standardized: parseFloat(standardizedImprovedSanitation.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-green-600 p-6 text-white">
          ...
          <p className="mt-2 text-blue-100">Assess and save your city&apos;s improved sanitation data</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Improved Sanitation measures the percentage of households with access to improved sanitation facilities, assessing hygiene and health conditions.
                ...
                <p className="font-mono mb-2">Improved Sanitation (raw) = (Households with Improved Sanitation / Total Households) * 100%</p>
                <p className="mb-2">
                ...
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of households with improved sanitation (non-negative).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like national censuses or health reports.</li>
          ...
          {decision && actualImprovedSanitation && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Improved Sanitation</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualImprovedSanitation}%
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg">Standardized Sanitation Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
