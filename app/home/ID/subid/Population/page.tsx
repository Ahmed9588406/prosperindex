...
function PopulationDensityForm() {
  ...
  // New states for raw population density and standardized score (for display and charts)
  const [actualPopulationDensity, setActualPopulationDensity] = useState<string | null>(null);
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const savedPopulation = localStorage.getItem("cityPopulation");
      const savedArea = localStorage.getItem("urbanArea");

      if (savedPopulation) setCityPopulation(savedPopulation);
      if (savedArea) setUrbanArea(savedArea);
    }
  }, []);
  ...
  const calculatePopulationDensity = async () => {
    ...
    if (numericUrbanArea > 0) {
      ...
      setActualPopulationDensity(populationDensity.toFixed(2));
      setStandardizedScore(standardizedDensity.toFixed(2));
      ...
      const postData = {
        ...
        population_standardized: parseFloat(standardizedDensity.toFixed(2)),
        population_comment: evaluationComment,
        userId: user.id,
      };
      ...
      toast.error("Urban area must be greater than zero.");
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Population Density measures the number of people per square kilometer in the urban area, assessing urban concentration.
                ...
                <p className="font-mono mb-2">Population Density (raw) = (Population / Urban Area) per km²</p>
                <p className="mb-2">
                  Standardized score maps density to 100..0 with benchmark X so closer to X → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the total city population (non-negative).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like national censuses or urban planning agencies.</li>
          ...
          {decision && actualPopulationDensity && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Population Density</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualPopulationDensity} per km²
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg">Standardized Density Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
