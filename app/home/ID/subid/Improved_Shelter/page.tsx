...
function ImprovedShelterForm() {
  ...
  // New states for raw improved shelter percentage and standardized score (for display and charts)
  const [actualImprovedShelter, setActualImprovedShelter] = useState<string | null>(null);
  ...
  const calculateImprovedShelter = async () => {
    ...
    if (numericTotalHouseholds > 0) {
      ...
      setActualImprovedShelter(improvedShelter.toFixed(2));
      setStandardizedScore(standardizedImprovedShelter.toFixed(2));
      ...
      const postData = {
        ...
        improved_shelter_standardized: parseFloat(standardizedImprovedShelter.toFixed(2)),
      ...
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-green-600 p-6 text-white">
          ...
          <p className="mt-2 text-blue-100">
            Assess and save your city&apos;s improved shelter data
          </p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Improved Shelter measures the percentage of households with durable housing, assessing living conditions.
                ...
                <p className="font-mono mb-2">Improved Shelter (raw) = (Durable Households / Total Households) * 100%</p>
                <p className="mb-2">
                ...
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of households with durable shelter (non-negative).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like national censuses or housing reports.</li>
          ...
          {decision && actualImprovedShelter && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Improved Shelter</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualImprovedShelter}%
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg">Standardized Shelter Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
