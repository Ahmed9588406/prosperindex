...
function SufficientLivingForm() {
  ...
  // New states for raw sufficient living percentage and standardized score (for display and charts)
  const [actualSufficientLiving, setActualSufficientLiving] = useState<string | null>(null);
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const savedDurable = localStorage.getItem("sufficientLivingDurableHouseholds");
      const savedTotal = localStorage.getItem("sufficientLivingTotalHouseholds");
  ...
  const handleDurableChange = (value: string) => {
    ...
    if (typeof window !== "undefined") {
      localStorage.setItem("sufficientLivingDurableHouseholds", value);
    }
  };
  ...
  const handleTotalChange = (value: string) => {
    ...
    if (typeof window !== "undefined") {
      localStorage.setItem("sufficientLivingTotalHouseholds", value);
    }
  };
  ...
  const calculateSufficientLiving = async () => {
    ...
    if (numericTotalHouseholds > 0) {
      ...
      setActualSufficientLiving(sufficient_living.toFixed(2));
      setStandardizedScore(standardizedSufficientLiving.toFixed(2));
      ...
      const postData = {
        ...
        sufficient_living_standardized: parseFloat(standardizedSufficientLiving.toFixed(2)),
        sufficient_living_comment: evaluationComment,
        userId: user.id,
      };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Sufficient Living measures the percentage of households with adequate living space, assessing housing quality.
                ...
                <p className="font-mono mb-2">Sufficient Living (raw) = (Households with Sufficient Living / Total Households) * 100%</p>
                <p className="mb-2">
                ...
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of households with sufficient living area (non-negative).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like national censuses or housing surveys.</li>
          ...
          {decision && actualSufficientLiving && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Sufficient Living</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualSufficientLiving}%
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg">Standardized Living Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
