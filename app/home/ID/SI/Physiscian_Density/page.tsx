...
const PhysicianDensityForm: React.FC = () => {
  ...
  // New states for raw physician density and standardized score (for display and charts)
  const [actualPhysicianDensity, setActualPhysicianDensity] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    setActualPhysicianDensity(density.toFixed(2));
    ...
    const postData = {
      ...
      physician_density_standardized: parseFloat(standardized.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Physician Density measures the number of physicians per 1,000 population, assessing healthcare access.
                ...
                <p className="font-mono mb-2">Physician Density (raw) = (Physicians / Population) * 1,000</p>
                <p className="mb-2">
                ...
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of physicians (non-negative).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like WHO or national health statistics.</li>
          ...
          {evaluation && actualPhysicianDensity && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Physician Density</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualPhysicianDensity} per 1,000 ({(parseFloat(actualPhysicianDensity) / 10).toFixed(2)}%)
                    </p>
                  </div>
