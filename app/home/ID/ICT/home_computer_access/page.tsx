...
const HomeComputerAccessForm: React.FC = () => {
  ...
  // New states for raw home computer access percentage and standardized score (for display and charts)
  const [actualHomeComputerAccess, setActualHomeComputerAccess] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    setActualHomeComputerAccess(computerAccess.toFixed(2));
    ...
    const postData = {
      ...
      home_computer_access_standardized: parseFloat(standardizedValue.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Home Computer Access measures the percentage of households with home computers, assessing digital access.
                ...
                <p className="font-mono mb-2">Home Computer Access (raw) = (Households with Computers / Total Households) * 100%</p>
                <p className="mb-2">
                  Standardized score maps the percentage to 100..0 with benchmark MAX so higher access → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the number of households with home computers (non-negative).</li>
          ...
          {evaluation && actualHomeComputerAccess && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Home Computer Access</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualHomeComputerAccess}%
                    </p>
                  </div>
