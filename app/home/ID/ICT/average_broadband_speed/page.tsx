...
function BroadbandSpeedCalculator() {
  ...
  // New states for raw average broadband speed and standardized score (for display and charts)
  const [actualBroadbandSpeed, setActualBroadbandSpeed] = useState<string | null>(null);
  ...
  const calculateStandardizedBroadbandSpeed = () => {
    ...
    setActualBroadbandSpeed(avgSpeed.toFixed(2));
  ...
  const handleCalculateAndSave = async () => {
    ...
    try {
      ...
      const postData = {
        ...
        average_broadband_speed_standardized: parseFloat(standardizedScore || '0'),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Average Broadband Speed measures the mean download speed of internet connections in Mbps.
                  This tool calculates the raw average speed from the speeds you provide and converts it into a standardized 0–100 score using predefined benchmarks.
                </p>
                <p className="font-mono mb-2">Average Broadband Speed (raw) = Mean of speeds (Mbps)</p>
                <p className="mb-2">
                  Standardized score maps the cube root of average speed to 100..0 across benchmarks (MIN..MAX) so higher speed → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter speeds as a comma-separated list of numbers (in Mbps).</li>
                  <li>Provide speeds for the same time period and measurement method.</li>
                  <li>At least one valid speed is required.</li>
                </ul>

                <h4 className="font-semibold mt-2 mb-1">Tips for meaningful results</h4>
                <ul className="list-disc list-inside">
                  <li>Ensure data is sourced consistently (e.g., from the same provider or test).</li>
                  <li>For comparisons, use data from reliable sources like Ookla or national regulators.</li>
          ...
          {comment && actualBroadbandSpeed && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Broadband Speed</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualBroadbandSpeed} Mbps
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg">Standardized Speed Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
