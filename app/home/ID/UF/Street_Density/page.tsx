...
function StreetDensityCalculator() {
  ...
  // New states for raw street density and standardized score (for display and charts)
  const [actualStreetDensity, setActualStreetDensity] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    setActualStreetDensity(streetDensity.toFixed(2));
    ...
    const postData = {
      ...
      street_density_standardized: parseFloat(standardizedScoreValue.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-green-600 p-6 text-white">
          ...
          <p className="mt-2 text-blue-100">Assess and save your city&apos;s street density data</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Street Density measures the length of streets per unit area in the urban environment, assessing connectivity and walkability.
                ...
                <p className="font-mono mb-2">Street Density (raw) = (Street Length / Urban Area) km/km²</p>
                <p className="mb-2">
                ...
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the total length of urban streets (in km).</li>
                  <li>Enter the total urban surface area (in km², must be greater than zero).</li>
          ...
          <div className="mb-6">
            <label className="block mb-3 font-semibold text-gray-700 flex items-center">
              🛣️ Total Length of Urban Streets (in km):
            </label>
            <input
          ...
          {decision && actualStreetDensity && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Street Density</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualStreetDensity} km/km²
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg">Standardized Street Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
