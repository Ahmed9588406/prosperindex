...
function LandAllocatedToStreetsCalculator() {
  ...
  // New states for raw land allocated percentage and standardized score (for display and charts)
  const [actualLandAllocated, setActualLandAllocated] = useState<string | null>(null);
  const [standardizedScore, setStandardizedScore] = useState<number | null>(null); // store numeric score for calculations
  ...
  const calculateAndSave = async () => {
    ...
    setActualLandAllocated(landAllocated.toFixed(2));
    ...
    const postData = {
      ...
      land_allocated_to_streets_standardized: parseFloat(standardizedScoreValue.toFixed(2)),
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Land Allocated to Streets measures the percentage of urban area dedicated to streets and transportation.
                ...
                <p className="font-mono mb-2">Land Allocated to Streets (raw) = (Street Surface / Total Urban Area) * 100%</p>
                <p className="mb-2">
                  Standardized score maps the percentage to 100..0 across benchmarks (MIN..MAX) so higher allocation → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the total surface area of urban streets (in km²).</li>
                  <li>Enter the total urban area (in km², must be greater than zero).</li>
          ...
          {decision && actualLandAllocated && standardizedScore !== null && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Land Allocated to Streets</h3>
                  ...
                  <div>
                    <h3 className="text-lg">Standardized Streets Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
