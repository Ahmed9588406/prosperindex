...
function StreetIntersectionDensityForm() {
  ...
  // New states for raw street intersection density and standardized score (for display and charts)
  const [actualStreetIntersectionDensity, setActualStreetIntersectionDensity] = useState<string | null>(null);
  ...
  const calculateAndSave = async () => {
    ...
    setActualStreetIntersectionDensity(streetIntersectionDensity.toFixed(2));
    setStandardizedScore(parseFloat(standardizedScoreValue.toFixed(2)));
    ...
    const postData = {
      ...
      street_intersection_density_standardized: parseFloat(standardizedScoreValue.toFixed(2)),
  ...
  const standardizedValue = standardizedScore ?? 0;
  const pieData = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-2xl rounded-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-green-600 p-6 text-white">
          ...
          <p className="mt-2 text-blue-100">Assess and save your city&apos;s intersection density data</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mb-4">
            ...
            {showSummary && (
              <div id="summary-panel" className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-md text-sm text-gray-700">
                <p className="mb-2">
                  Street Intersection Density measures the number of street intersections per unit area in the urban environment, assessing connectivity and walkability.
                  This tool calculates the raw density from the inputs you provide and converts it into a standardized 0–100 score using predefined benchmarks.
                </p>
                <p className="font-mono mb-2">Street Intersection Density (raw) = (Intersections / Urban Area) per km²</p>
                <p className="mb-2">
                  Standardized score maps density to 100..0 with benchmark BENCHMARK so closer to benchmark → higher score.
                </p>

                <h4 className="font-semibold mt-2 mb-1">What to enter</h4>
                <ul className="list-disc list-inside mb-2">
                  <li>Enter the total number of street intersections.</li>
                  <li>Enter the urban area in km² (must be greater than zero).</li>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>For comparisons, use data from reliable sources like urban planning maps.</li>
          ...
          {decision && actualStreetIntersectionDensity && standardizedScore && (
            <div className="mt-8 p-6 bg-gray-50 rounded-lg border">
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-lg">Actual Street Intersection Density</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {actualStreetIntersectionDensity} per km²
                    </p>
                  </div>

                  <div>
                    <h3 className="text-lg">Standardized Intersection Score</h3>
                    <p className="text-2xl font-bold text-gray-800">
                      {standardizedScore}%
                    </p>
                  </div>
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="w-full h-64">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={[
                        { name: 'Standardized', value: standardizedValue }
                      ]}>
